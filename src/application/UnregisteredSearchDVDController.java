...
public class UnregisteredSearchDVDController implements Initializable{
	@FXML
		...
		try {
            ...
            if (titles.equals("") && directorFirstName.equals("") && directorLastName.equals("") && countries.equals("") && genres.equals("")) {
            	...
            	searchWarning.setText("");
            	  FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/UnregisteredDVDSearchResult.fxml"));
            	  UnregisteredDVDSearchResultController dvdSearchResCon = new UnregisteredDVDSearchResultController(titles, directorFirstName, directorLastName, countries, genres);
