...
public class StudentSearchBookResultController implements Initializable{
	...
	public StudentSearchBookResultController() {
		
	}

	public StudentSearchBookResultController(String titles, String authorFirstName, String authorLastName, String countries, String subjects, String isbn) {
		this.titles = titles;
