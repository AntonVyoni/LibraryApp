...
public class UnregisteredSearchPaperController implements Initializable{
	@FXML
		...
		try {
            ...
            if (titles.equals("") && numbers.equals("") && countries.equals("") && subjects.equals("") && publishers.equals("")) {
            	...
            	searchWarning.setText("");
            	  FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/UnregisteredPaperSearchResult.fxml"));
            	  UnregisteredPaperSearchResultController paperSearchResCon = new UnregisteredPaperSearchResultController(titles, numbers, countries, subjects, publishers);
