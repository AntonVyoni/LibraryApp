...
public class UnregisteredSearchBookController implements Initializable{
	@FXML
	private TextField searchTitleTxt;
	@FXML
	private Button searchExecute;
	@FXML
	private TextField searchAuthorFirstNameTxt;
	@FXML
	...
	@FXML
	private TextField searchAuthorLastNameTxt;
	@FXML
		...
		try {
            ...
            if (titles.equals("") && authorFirstName.equals("") && authorLastName.equals("") 
            	...
            	searchWarning.setText("");
            	  FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/UnregisteredBookSearchResult.fxml"));
            	  UnregisteredBookSearchResultController searchResCon = new UnregisteredBookSearchResultController(titles, authorFirstName, authorLastName, countries, subjects, isbn);
	...
	public void goBack(ActionEvent event) {
		try {
			...
			Pane root = loader.load(getClass().getResource("/application/UnregisteredChooseSearchType.fxml").openStream());
