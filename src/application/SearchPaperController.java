...
public class SearchPaperController implements Initializable {
	@FXML
		...
		try {
            ...
            if (titles.equals("") && numbers.equals("") && countries.equals("") && subjects.equals("") && publishers.equals("")) {
            	...
            	searchWarning.setText("");
            	  FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/PaperSearchResult.fxml"));
            	  PaperSearchResultController paperSearchResCon = new PaperSearchResultController(titles, numbers, countries, subjects, publishers);
