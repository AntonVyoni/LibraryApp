...
public class StudentPaperSearchResultController implements Initializable{
	...
	public StudentPaperSearchResultController(String titles, String numbers, String countries, String subjects, String publishers) {
		this.titles = titles;
