...
public class StudentSearchBookController implements Initializable{
	@FXML
		...
		try {
            ...
            if (titles.equals("") && authorFirstName.equals("") && authorLastName.equals("") 
            	...
            	searchWarning.setText("");
            	  FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/StudentBookSearchResult.fxml"));
                  StudentSearchBookResultController searchResCon = new StudentSearchBookResultController(titles, authorFirstName, authorLastName, countries, subjects, isbn);
