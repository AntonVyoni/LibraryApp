...
public class SearchDVDController implements Initializable {
	@FXML
		...
		try {
            ...
            if (titles.equals("") && directorFirstName.equals("") && directorLastName.equals("") && countries.equals("") && genres.equals("")) {
            	...
            	searchWarning.setText("");
            	  FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/DVDSearchResult.fxml"));
                  DVDSearchResultController dvdSearchResCon = new DVDSearchResultController(titles, directorFirstName, directorLastName, countries, genres);
